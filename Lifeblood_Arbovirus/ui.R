...
full_data <- read_csv("../../Data/fulldata.csv")
  ...
  navbarPage(position = "fixed-top","Arbovirus Transmission",
             tabPanel("Incidence Rate",
                    ...
                    fluidRow(HTML("<br><h2>Comparison of Cummulative Incidence Rate</h2>"),
                             column(width = 4, HTML('<img src="gganim_imp.gif" width="600" height="650">')),
                             column(width = 2),
                             column(width = 4, HTML('<img src="gganim_local.gif" width="600" height="650">'))
                    )),
