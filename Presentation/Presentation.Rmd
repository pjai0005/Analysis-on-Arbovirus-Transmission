...
`r emo::ji("mosquito")` About Dr. Elvina Viennet (Researcher at Redcross Lifeblood)
...
* SA3 region boundaries are taken from 2011 census period
]
...
1. Dataset containing variables related to case count, incidence rate, donation rate, geographical information and weather conditions for the years 2007 - 2017
  
2. Dataset comprising of Imported Viruses, case counts and imported country names. 
...
2. World Shape file containing country borders for all 195 countries
...
* Replaced country names like
  ...
  * United Kingdom, Channel Islands and Isle of Man → Hong Kong
...
* No clear relationship between SA3 regions, donation rate and incidence rate
...
.pull-left[
* Donation Rate and Population are the most important contributors for the first PC
